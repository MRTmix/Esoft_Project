    ...
    public partial class FormRealEstate : Form
    {
        ...
        void ShowRealEstatesSet()
        {
            ...
            foreach (RealEstateSet realEstateSet in Program.wftDb.RealEstateSet)
            {
                ...
                realEstateSet.Address_City, realEstateSet.Address_Street, realEstateSet.Address_House,
                realEstateSet.Address_Number, realEstateSet.Coordinate_latitude.ToString(), realEstateSet.Coordinate_longitude.ToString(),
                ...
                else
                {
                    ...
                    ListViewItem item = new ListViewItem(new string[]{
                realEstateSet.Address_City, realEstateSet.Address_Street,
                realEstateSet.Coordinate_latitude.ToString(), realEstateSet.Coordinate_longitude.ToString(),
